        ...
        for NameProject, NameJob, parsed_data in parsed_files_data:
            for data in parsed_data['nodes']:
                for elem_param in data['elementParameters']:
                    ...
                    params = (aud_componentName, aud_posX, aud_posY, aud_typeField, 
                     aud_elementRef, aud_valueElementRef, aud_id, aud_columnName, aud_componentValue, NameProject, NameJob, exec_date)
